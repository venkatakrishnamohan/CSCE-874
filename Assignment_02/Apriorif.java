...
public class Apriori {
    ...
    public static void main(String[] args) {
        ...
        try {
    		...
    		PrintWriter output = new PrintWriter(location+"output.txt");
            double minsuparg = Double.parseDouble(args[1]);
            ...
            List<String> newinst = InstancetoInd(instances);
            int minsup = (int) (minsuparg*newinst.size());
            //System.out.println(newinst);
            //System.out.println(d);
            Map<String,Integer> c1 = supportcountone(newinst);
            //Map<String,Integer> currentcandidates = c1;
            saveCandidateItems(c1);
            //System.out.println(c1.size());
            //System.out.println("Candidates size: 1");
        ...
        for(int a = 0; a<li.size(); a++){//go through each frequent itemset
           ...
           for(int i=0;i< subset.size();i++) {
        	   String stri = "";
                ...
                //String lookfor = String.join(",", subset);
                ...
                if(subset.get(i).contains(",")) {
                  aa = subset.get(i).split(",");
                    ...
                    //Milk Coke, but cmap contains Coke,Milk
                ...
                if (confidence >= minconf) {
                   ...
                   // c.removeAll(subset);// I - s
                    ...
                    //System.out.println(stri); //format printing here
    ...
    public static List<String> getFrequentItemSets(Map<String,Integer> cs,Integer minsup){
    ...
    public static List<String> InstancetoInd(List<String> instances) {
        ...
        for(int i=0;i<instances.size();i++) {
            ...
            newinst.add(s.substring(0, s.length()-1));
        }
        return newinst;
    }
    ...
    public static Map<String,Integer> supportcountone(List<String> newinst){
		...
		/*for(int i=d.size()-1;i<d.size()-1+cv.length;i++) {
			l1.put(Character.toString(cv[i-d.size()+1].charAt(0)),0);
		}*/
        for(int i=0;i<newinst.size();i++) {
			...
			/*for(int j=0;j<cv.length;j++) {
				if(a[a.length-1].equals(Character.toString(cv[j].charAt(0)))) {
					l1.put(Character.toString(cv[j].charAt(0)), l1.get(Character.toString(cv[j].charAt(0)))+1);
				}
			}*/
        }
        return l1;
