...
df_all <- read.csv('Final_association/compressed_association_final_instances.csv')
df <- read.csv('Final_association/compressed_association_final.csv')
